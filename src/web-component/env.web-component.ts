export const DATA_HOST = import.meta.env.DATA_HOST;
export const DEFAULT_MAP_CENTRE_LNG = import.meta.env.DEFAULT_MAP_CENTRE_LNG;
export const DEFAULT_MAP_CENTRE_LAT = import.meta.env.DEFAULT_MAP_CENTRE_LAT;
